...
void ShareNode::initMenu(){
    ...
    item1->setPosition(Vec2(size.width*7/8, size.height*3/8+item1->getContentSize().height*5/2));
    ...
    item2->setPosition(Vec2(size.width*7/8, size.height*3/8+item2->getContentSize().height));
    ...
    item3->setPosition(Vec2(size.width*7/8, size.height*3/8-item3->getContentSize().height/2));
    ...
    item4->setPosition(Vec2(size.width*7/8, size.height*3/8-item4->getContentSize().height*2));
